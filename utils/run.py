...
def get_llm_prompt(room_json:str, room_size:int):
    prompt = ROOM_PROMPT.format(room_json=room_json, room_size=room_size)
    pass
...
if __name__ == "__main__":
    ...
    pdb.set_trace()
    # render_room_dataset_improved_mat_of_single_scene(args.scene_id)